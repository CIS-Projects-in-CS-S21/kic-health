...
type Repository interface {
	GetOverallScore(ctx context.Context, userID int64) (float64, error)
	...
	UpdateMentalHealthLogs(ctx context.Context, userID int64, healthLog *pbhealth.MentalHealthLog) ([]*pbhealth.MentalHealthLog, error)
}
